...
<div class="main pb-3">    
    ...
    <h2 class="mb-4">Staff List</h2>
            <div class="table-responsive">
                <table  id="staffTable" class="table nowrap w100 table-striped resize-table table-hover">
                    <thead>
                        <tr>
                            <th >Sno</th>
                            <th>Ins Id</th>
...
console.log(response);
            let staffTable = $('#staffTable tbody');
            staffTable.empty();
            $.each(response.staffList, function(index, staff) {
                let row = '<tr>' +
                    '<td>' + (index + 1) + '</td>' +
                    '<td>' + staff.instituteId + '</td>' +
                    '<td>' + staff.staffId + '</td>' +
                    '<td><img src="' + staff.profileImagePath + '" alt="Profile Image" class="rounded-circle" width="50" height="50"></td>' +
                    '<td>' + staff.firstName + " " + staff.lastName + '</td>' +
                    '<td>' + staff.email + '</td>' +
                    '<td>' + staff.phoneNumber + '</td>' +
                    '<td>' + staff.doorno + ', ' + staff.area + ', ' + staff.street + '</td>' +
                    '<td>' + staff.city + '</td>' +
                    '<td>' + staff.state + '</td>' +
                    '<td>' + staff.pincode + '</td>' +
                    '<td>' + staff.country + '</td>' +
                    '<td>' + staff.dateOfJoining.dayOfMonth + '-' + staff.dateOfJoining.month + '-' + staff.dateOfJoining.year + '</td>' +
                    '<td>' + staff.qualification + '</td>' +
                    '<td>' + staff.salary + '</td>' +
                    '<td>' + staff.experience + '</td>' +
                    '<td>' +
                    '<img src="assets/images/List/edit.png" title="Edit" alt="edit" class="edit-btn" data-id="' + staff.staffId + '" style="cursor:pointer;"> &nbsp;' +
                    '<img src="assets/images/List/delete.png" title="Delete" class="delete-btn" data-id="' + staff.staffId + '" alt="delete" style="cursor:pointer;">' +
                    '</td>' +
                    '</tr>';
